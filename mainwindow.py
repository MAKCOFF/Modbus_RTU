...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_add_items = QtWidgets.QPushButton(self.centralWidget)
        self.btn_add_items.setGeometry(QtCore.QRect(170, 200, 90, 30))
        self.btn_add_items.setObjectName("btn_add_items")
        self.btn_del_items = QtWidgets.QPushButton(self.centralWidget)
        self.btn_del_items.setGeometry(QtCore.QRect(280, 200, 90, 30))
        self.btn_del_items.setObjectName("btn_del_items")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_add_items.setText(_translate("MainWindow", "ADD items"))
        self.btn_del_items.setText(_translate("MainWindow", "DEL item"))
